const diffRequestHandler = (req, res) => {
  console.log("In Difference Request Handler", req.url);
    ...
    <html>
      ...
      <body>
          <div class="result-container">
              ...
              <h1>Difference Result: ${result}</h1>
              <br>
              <a href="/diff" class="btn btn-primary">Calculate Another Difference</a>
